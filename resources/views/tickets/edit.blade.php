<x-base-layout>
    <div class="max-w-xl mx-auto p-6 bg-white rounded-lg shadow-md mt-6">
        <h1 class="text-3xl font-bold mb-6">Ticket Bewerken</h1>
                ...
                >
                    ...
                    @foreach ($performances as $performance)
                        <option value="{{ $performance->id }}"
                            {{ (int) old('performance_id', $ticket->performance_id) === $performance->id ? 'selected' : '' }}>
    ...
    <!-- Validatie errors -->
    @if ($errors->any())
        <div class="max-w-xl mx-auto mt-4 bg-red-100 text-red-800 p-4 rounded">
